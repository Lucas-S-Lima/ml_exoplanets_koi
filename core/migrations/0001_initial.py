# Generated by Django 6.0.7 on 2026-08-05 00:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algorithm', models.CharField(choices=[('logistic_regression', 'Logistic Regression'), ('random_forest', 'Random Forest'), ('svm', 'SVM'), ('gradient_boosting', 'Gradient Boosting')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(choices=[('exoplanet', 'EXOPLANET'), ('false_positive', 'FALSE POSITIVE')], max_length=20)),
                ('probability', models.DecimalField(decimal_places=4, max_digits=5)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='predictions', to='core.exoplanetcandidate')),
            ],
        ),
    ]
